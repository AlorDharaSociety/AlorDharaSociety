const volunteers = [
  {name:"Shadman Sakib Khan", role:"Position: 1", year:2026, img:"images/GV_shadman.jpg", icon:"👤"},
  {name:"A", role:"Position: 2", year:2026, img:"images/GV_.jpg", icon:"👤"},
  {name:"c", role:"Position: 3", year:2026, img:"images/GV_.jpg", icon:"👤"},
  {name:"d", role:"Position: 4", year:2026, img:"images/GV_.jpg", icon:"🌟"},
  {name:"e", role:"Position: 2", year:2026, img:"images/GV_.jpg", icon:"🏆"},
];

// ===== Change area start =====

const projects = [
  {id:1,year:2013,name:"Shadman Sakib Khan",desc:"hredoykhan523@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_shadman.jpg", icon:"👤"},
  {id:2,year:2013,name:"Shamsi Binta Bari",desc:"shamsibintebari@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_shamsi.jpg", icon:"👤"},
  {id:3,year:2019,name:"Rokshana Ferdous",desc:"rokshanaferdouss@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_roksana.jpg", icon:"👤"},
  {id:4,year:2019,name:"Joynob Binte Rahman",desc:"joynobbinterahman@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_joynob.jpg", icon:"👤"},
  {id:5,year:2019,name:"Md. Fahim Abdullah",desc:"fahim.fxm@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_fahim.jpg", icon:"👤"},
  {id:5,year:2019,name:"Tafsia Hossain",desc:"tafsiahossainfn@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_tafsia.jpg", icon:"👤"},
  {id:5,year:2019,name:"Antora Pervin",desc:"smshomrat172@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_antora.jpg", icon:"👤"},
  {id:5,year:2019,name:"Maria Islam Shanta",desc:"mariaislamshanta1@gmail",beneficiaries:0,status:"Active",img:"images/GV_maria.jpg", icon:"👤"},
  {id:5,year:2019,name:"Cynthiya Sarkar Hiya",desc:"hiyasynthiya@gmail.com",beneficiaries:0,status:"Active",img:"images/GV_hiya.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GV_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GV_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GV_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GV_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GV_.jpg", icon:"👤"},
...
const mediaItems = {
  images:[
    ...
    {title:"a",desc:"b",type:"Online",img:"images/TR_roksana.jpg"},
...
function renderProjectTable(filter, data) {
  ...
  ${p.img
    ? `<img src="${p.img}" alt="${p.name}"
          style="width:60px;height:60px;border-radius:10px;object-fit:cover;display:block;"
          onerror="this.outerHTML='<div style=\'width:60px;height:60px;border-radius:10px;background:linear-gradient(135deg,var(--green),var(--gold));display:flex;align-items:center;justify-content:center;font-size:1.5rem;\'>${p.icon||'👤'}</div>'"
       />`
    : `<div style="width:60px;height:60px;border-radius:10px;background:linear-gradient(135deg,var(--green),var(--gold));display:flex;align-items:center;justify-content:center;font-size:1.5rem;">${p.icon||'👤'}</div>`
  }
</td>
      <td><strong>${p.name}</strong></td>
      <td>${p.year}</td>
      <td style="max-width:300px;">${p.desc}</td>
      <td><span class="status-badge ${p.status==='done'?'status-done':'status-Active'}">${p.status==='done'?'✅ Completed':'🔄 Active'}</span></td>
...
function renderSwiper() {
  ...
  track.innerHTML = volunteers.map((v, i) => `
    <div class="swiper-card" id="sc${i}">
        ...
        ${v.img
          ? `<img src="${v.img}" alt="${v.name}"
             ...
             <div style="display:none;width:100%;height:100%;align-items:center;justify-content:center;
                  font-size:3.5rem;background:linear-gradient(135deg,var(--green),var(--gold));color:#fff;">
               ${v.icon || '👤'}
             </div>`
      ...
      <div class="card-body">
        <div class="card-year">⭐ Best Volunteer ${v.year}</div>
        <div class="card-title">${v.name}</div>
        <div class="card-desc">${v.role}</div>
      </div>
    </div>
  `).join('');
  updateSwiper();
