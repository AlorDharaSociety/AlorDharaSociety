const members = [
  {name:"Roma Akter", role:"Position: 1", year:2026, img:"images/GM_roma.png", icon:"👤"},
  {name:"A. Rahim Khan", role:"Position: 2", year:2026, img:"images/GM_rahim.png", icon:"👤"},
  {name:"c", role:"Position: 3", year:2026, img:"images/GM_.jpg", icon:"👤"},
  {name:"d", role:"Position: 4", year:2026, img:"images/GM_.jpg", icon:"🌟"},
  {name:"e", role:"Position: 2", year:2026, img:"images/GM_.jpg", icon:"🏆"},
];

// ===== Change area start =====

const projects = [
  {id:1,year:2013,name:"Roma Akter",desc:"romaakter1745@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_roma.png", icon:"👤"},
  {id:2,year:2013,name:"A. Rahim Khan",desc:"rk4900090@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_rahim.png", icon:"👤"},
  {id:3,year:2019,name:"Mahima Akter",desc:"akhtermahi9320@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_mahi.png", icon:"👤"},
  {id:4,year:2019,name:"Umme Hafsa Eva",desc:"ummehafsaeva930@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_ibnitah.jpg", icon:"👤"},
  {id:5,year:2019,name:"Efran Sultana Eva",desc:"evaisrat26@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_eva.jpg", icon:"👤"},
  {id:5,year:2019,name:"Kamrunaher Tisha",desc:"ttanjin759@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_tisha.jpg", icon:"👤"},
  {id:5,year:2019,name:"Habiba Akter Era",desc:"halimaesa6@gmail.com",beneficiaries:0,status:"Active",img:"images/GM_habiba.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GM_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GM_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GM_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GM_.jpg", icon:"👤"},
  {id:5,year:2019,name:"",desc:"",beneficiaries:0,status:"Active",img:"images/GM_.jpg", icon:"👤"},
...
function renderSwiper() {
  ...
  track.innerHTML = members.map((v, i) => `
    <div class="swiper-card" id="sc${i}">
      ...
      <div class="card-body">
        <div class="card-year">⭐ Best Members ${v.year}</div>
