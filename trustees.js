...
const projects = [
  {id:10,year:2026,name:"Toma",desc:"General Secretary",beneficiaries:2000,status:"ongoing",img:""},
  {id:11,year:2026,name:"Hiya",desc:"Treasurer",beneficiaries:300,status:"ongoing",img:""},
  {id:12,year:2026,name:"Roksana",desc:"Secretary",beneficiaries:150,status:"ongoing",img:"images/TR_roksana.jpg"},
  {id:13,year:2026,name:"Enan",desc:"Co-Ordinator",beneficiaries:4000,status:"ongoing",img:""},
  {id:14,year:2026,name:"Fahim",desc:"Fund Raiser",beneficiaries:8000,status:"ongoing",img:""},
];
      ...
      <div class="card-img" style="position:relative;overflow:hidden;">
        ${p.img
          ? `<img src="${p.img}" alt="${p.name}"
             ...
             <div style="display:none;width:100%;height:100%;align-items:center;justify-content:center;font-size:3rem;background:linear-gradient(135deg,var(--green),var(--gold));color:#fff;">
               ${p.icon||'🌟'}
             </div>`
          : `<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:3rem;background:linear-gradient(135deg,var(--green),var(--gold));color:#fff;">
               ${p.icon||'🌟'}
             </div>`
        }
      </div>
